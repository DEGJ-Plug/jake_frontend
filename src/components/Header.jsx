...
const Header = () => {
  ...
  return (
    <header className="flex md:flex-row flex-col md:justify-between md:items-center md:mx-12 mx-4 my-3 sticky top-0">
      ...
      >
        <button className="bg-white p-3 text-blue-600 rounded-md hover:text-blue-700 shadow-md shadow-gray-600 border-2 border-blue-600 mr-4 md:w-[90px] w-full md:mb-0 mb-2 md:hover:bg-blue-600 md:hover:text-white md:hover:border-white">
